...
export const gradeData = () => {
  ...
  writeFile(
    ...
    JSON.stringify(
      {
        'LEVEL 16': {
          'S+': lv16.filter((_) => parseInt(_.hard_ratio.split('%')[0]) <= 50),
          S: lv16.filter(
            (_) =>
        ...
        'LEVEL 17': {
          'S+': lv17.filter((_) => parseInt(_.hard_ratio.split('%')[0]) <= 50),
          S: lv17.filter(
            (_) =>
              50 < parseInt(_.hard_ratio.split('%')[0]) &&
              parseInt(_.hard_ratio.split('%')[0]) <= 55
        ...
        'LEVEL 18': {
          'S+': lv18.filter((_) => parseInt(_.hard_ratio.split('%')[0]) <= 30),
          S: lv18.filter(
            (_) =>
        ...
        'LEVEL 19': {
          'S+': lv19.filter((_) => parseInt(_.hard_ratio.split('%')[0]) <= 30),
          S: lv19.filter(
            (_) =>
              30 < parseInt(_.hard_ratio.split('%')[0]) &&
              parseInt(_.hard_ratio.split('%')[0]) <= 40
        ...
        'LEVEL 20': {
          'S+': lv20.filter((_) => parseInt(_.hard_ratio.split('%')[0]) <= 5),
          S: lv20.filter(
            (_) =>
